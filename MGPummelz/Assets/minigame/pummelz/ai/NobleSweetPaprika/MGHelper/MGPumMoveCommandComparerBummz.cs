...
{
    public class MGPumMoveCommandComparerBummz : MGPumMoveCommandComparer
    {
        public MGPumMoveCommandComparerBummz(MGPumDecisionTree decisionTree, int preferableNumberOfPrey = 8) : base(decisionTree, preferableNumberOfPrey) { }
